...
class User(Base):
    ...
    select_limit = Column(Integer, default=3)  # 选品限制
    ads_count = Column(Integer, default=0)  # 投流分析次数
    ads_limit = Column(Integer, default=3)  # 投流分析限制
...
PLANS = {
    "free": {
        ...
        "select_limit": 3,
        "ads_limit": 3,
        "features": ["每月3次选品分析", "每月3次投流分析", "定价计算器", "新手教程"]
    },
    "basic": {
        "name": "基础版",
        "price_monthly": 49,
        ...
        "select_limit": 20,
        "ads_limit": 10,
        "features": ["每月20次选品分析", "每月10次投流分析", "定价计算器", "新手教程", "竞品分析", "数据导出"]
    },
    "pro": {
        "name": "专业版",
        "price_monthly": 129,
